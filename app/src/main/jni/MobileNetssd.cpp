...
Java_com_qy_detect_MobileNetssd_Init(JNIEnv *env, jobject obj, jbyteArray param, jbyteArray bin, jbyteArray words) {
...
JNIEXPORT jfloatArray JNICALL Java_com_qy_detect_MobileNetssd_Detect(JNIEnv* env, jobject thiz, jobject bitmap)
{
    // ncnn from bitmap
    ncnn::Mat in;
    {
